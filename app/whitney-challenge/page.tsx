...
export default function WhitneyChallengePage() {
  ...
  useEffect(() => {
    ...
    win.onYouTubeIframeAPIReady = () => {
      if (win.YT) {
        playerRef.current = new win.YT.Player("youtube-player-whitney", {
          videoId: "c6wn_pxxYWU",
          playerVars: {
            autoplay: 0,
            controls: 1,
      ...
      <div className="w-full max-w-4xl">
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-8">
          ...
          <div
            ...
            className="w-full max-w-4xl aspect-video mb-8"
          >
            <div id="youtube-player-whitney" className="w-full h-full rounded-lg" />
          </div>
